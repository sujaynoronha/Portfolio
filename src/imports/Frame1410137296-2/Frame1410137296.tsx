import imgRedmiNote11Pro from "./7e8b0d71784be311fb7ef076f4b9d403063ca394.png";
...
function Frame1() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#f3f3f3] h-[542px] left-1/2 overflow-clip top-1/2 w-[806px]">
      <div className="-translate-x-1/2 absolute h-[698px] left-1/2 top-[10px] w-[368px]" data-name="Redmi Note 11 Pro">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[123.9%] left-[-159.26%] max-w-none top-[-11.04%] w-[313.15%]" src={imgRedmiNote11Pro} />
        </div>
      </div>
    </div>
  );
