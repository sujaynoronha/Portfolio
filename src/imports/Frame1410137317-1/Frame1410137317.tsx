...
function Group1() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute contents left-[calc(50%+6.65px)] top-[calc(50%-0.12px)]">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex h-[487.293px] items-center justify-center left-[calc(50%+114.73px)] top-[calc(50%-0.47px)] w-[238.524px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
        <div className="flex-none rotate-2">
          <div className="h-[479.841px] relative w-[221.913px]" data-name="Redmi Note 11 Pro">
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex h-[509.763px] items-center justify-center left-[calc(50%-96.4px)] top-[calc(50%-0.12px)] w-[248.584px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
        <div className="-rotate-2 flex-none">
          <div className="h-[502px] relative w-[231.205px]" data-name="Redmi Note 11 Pro">
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
