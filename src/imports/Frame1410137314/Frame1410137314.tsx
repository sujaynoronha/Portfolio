import imgIPhone16PneWroblem11Portrait1 from "./90d4ca5a34d56ef58af0cd9a1cd11cc3df5cee23.png";
import imgIPhone16A38Portrait1 from "./d51c2f9765f3d9ea376f0fd1a94abbe1a2a9e2e3.png";
import imgIPhone1621Portrait1 from "./f65a248edb446fd96d7e765dd405d499d63106cf.png";
...
function Frame1() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#f3f3f3] h-[549px] left-1/2 overflow-clip top-1/2 w-[806px]">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[416px] left-[calc(50%-0.44px)] top-[calc(50%+23.5px)] w-[211.124px]" data-name="iPhone 16 -PNEWroblem 1.1-portrait 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgIPhone16PneWroblem11Portrait1} />
      </div>
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[416px] left-[calc(50%-0.44px)] top-[calc(50%+22.5px)] w-[211.124px]" data-name="iPhone 16a - 38-portrait 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgIPhone16A38Portrait1} />
      </div>
      <div className="-translate-x-1/2 absolute h-[792px] left-[calc(50%-0.03px)] top-[32px] w-[401.949px]" data-name="iPhone 16 - 21-portrait 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgIPhone1621Portrait1} />
      </div>
    </div>
  );
}
