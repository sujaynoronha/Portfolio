import imgFrame1410137305 from "./903555daa4d15991cc51468d9441342131f10d0f.png";
  ...
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#f3f3f3] h-[542px] left-1/2 overflow-clip top-1/2 w-[806px]">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex h-[549px] items-center left-[calc(50%-0.5px)] pb-[22px] pl-[283px] pr-[282px] pt-[23px] top-[calc(50%+0.5px)] w-[835px]">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgFrame1410137305} />
        <div className="flex h-[465.195px] items-center justify-center relative shrink-0 w-[267.767px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
        ...
        <div className="absolute flex h-[465.212px] items-center justify-center left-[283px] top-[45.65px] w-[267.8px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
          <div className="flex-none rotate-[-3.32deg]">
